...
const LoginForm = () => {
  ...
  return (
    <div className="min-vh-100 d-flex flex-column align-items-center justify-content-center bg-dark">
      <div className={`card p-4 shadow-lg ${shake ? 'animate-shake' : ''}`} style={{ maxWidth: '400px', width: '100%' }}>
        <div className="text-center mb-4">
          <img src="/logodept.png" alt="Logo" className="img-fluid" style={{ maxHeight: '137px' }} />
        </div>
